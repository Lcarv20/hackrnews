...
const menuStyles = "p-1 mt-2 border bg-popover rounded-lg overflow-hidden";
const groupHeadingStyles = "ml-3 mt-2 mb-1 text-accent text-sm";
const optionStyles = {
  base: "hover:cursor-pointer px-3 py-2 rounded truncate",
...
type CreatableSelectProps = Parameters<typeof CreatableSelect>[0];

export const CreatableChipsInput = (props: CreatableSelectProps) => {
  return (
    <CreatableSelect
      // isMulti
